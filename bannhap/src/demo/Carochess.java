        ...
        private void EvalChessBoard(int player,EvalBoard eBoard)
        {
            ...
            for (rw = 0; rw < _BanCo.getSoDong(); rw++)            
                for (cl = 0; cl < _BanCo.getSoCot()-4; cl++)
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        if (_MangOCo[rw][cl + i].getSohuu() == 1) eHuman++;
                        if (_MangOCo[rw][cl + i].getSohuu() == 2) ePC++;
                    }
            ...
            for (cl = 0; cl < _BanCo.getSoCot(); cl++)
                for (rw = 0; rw < _BanCo.getSoDong()-4; rw++)
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        if (_MangOCo[rw + i][cl].getSohuu() == 1) eHuman++;
                        if (_MangOCo[rw + i][cl].getSohuu() == 2) ePC++;
                    }
            ...
            for (cl = 0; cl < _BanCo.getSoCot() - 4; cl++)
                for (rw = 0; rw < _BanCo.getSoDong() - 4; rw++)
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        if (_MangOCo[rw + i][cl + i].getSohuu() == 1) eHuman++;
                        if (_MangOCo[rw + i][cl + i].getSohuu() == 2) ePC++;
                    }
